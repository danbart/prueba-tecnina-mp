            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex h-16 items-center justify-between">
                    ...
                    <nav className="ext-gray-700 dark:text-gray-200 hidden lg:flex space-x-4 xl:space-x-6">
                        ...
                        {token && (
                            <>
                                <NavItem className="text-gray-700 dark:text-gray-200 hover:text-purple-600 transition text-sm xl:text-base" to="/casos">Casos</NavItem>
                                <NavItem to="/casos/nuevo">Nuevo caso</NavItem>
                            </>
                        )}
                ...
                {mobileOpen && (
                    <div className="lg:hidden mt-3 border-t pt-3 space-y-2 pb-4">
                        ...
                        {token ? (
                            <>
                                <NavItem to="/casos">Casos</NavItem>
                                <NavItem to="/casos/nuevo">Nuevo caso</NavItem>
